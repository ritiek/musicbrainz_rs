...
impl Include {
    pub(crate) fn as_str(&self) -> &'static str {
        match self {
            ...
            Include::AreaRelations => "area-rels",
            Include::ArtistRelations => "artist-rels",
            Include::EventRelations => "event-rels",
            Include::InstrumentRelations => "instrument-rels",
            Include::LabelRelations => "label-rels",
            Include::PlaceRelations => "place-rels",
            Include::RecordingRelations => "recording-rels",
            Include::ReleaseRelations => "release-rels",
            Include::ReleaseGroupRelations => "release-group-rels",
            Include::SeriesRelations => "series-rels",
            Include::UrlRelations => "url-rels",
            Include::WorkRelations => "work-rels",
